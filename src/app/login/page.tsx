      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-white/60">Enter your credentials to access your portal</p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <button
              formAction={login}
              className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground py-3 rounded-xl font-semibold transition-all shadow-[0_0_20px_rgba(59,130,246,0.2)]"
            >
